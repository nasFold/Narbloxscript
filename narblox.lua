...
function Update:Window(text,logo,keybind)
	...
	Hubb.Text = "Version|0.1 Indonesia"
	Hubb.TextColor3 = Color3.fromRGB(255, 255, 255)
	Hubb.TextSize = 20.000
...
local LogoHub = Instance.new("ImageLabel")
	...
	LogoHub.Image = "http://www.roblox.com/asset/?id="..tostring(15954963285)
...
local LogoToggle = Instance.new("ImageLabel")
	...
	LogoToggle.Image = "http://www.roblox.com/asset/?id="..tostring(15954963285)
